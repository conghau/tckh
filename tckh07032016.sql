...
DELETE FROM `web_news_articles_full`;
...
DELETE FROM `web_news_categories`;
...
-- Dumping structure for table tckh.web_orders
CREATE TABLE IF NOT EXISTS `web_orders` (
  ...
  `status` tinyint(4) NOT NULL COMMENT '1: Dang tiep nhan, 2: Da giao hang',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `FK_web_orders_web_users` (`user_id`),
  CONSTRAINT `FK_web_orders_web_users` FOREIGN KEY (`user_id`) REFERENCES `web_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Đặt hàng tạp chí khoa học';

-- Dumping data for table tckh.web_orders: ~0 rows (approximately)
DELETE FROM `web_orders`;
/*!40000 ALTER TABLE `web_orders` DISABLE KEYS */;
/*!40000 ALTER TABLE `web_orders` ENABLE KEYS */;


-- Dumping structure for table tckh.web_orders_detail
CREATE TABLE IF NOT EXISTS `web_orders_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) NOT NULL,
  `tckh_id` int(11) NOT NULL,
  `price` float NOT NULL,
  `quantity` tinyint(4) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `FK_web_orders_detail_web_orders` (`order_id`),
  KEY `FK_web_orders_detail_web_tckh_tapchi` (`tckh_id`),
  CONSTRAINT `FK_web_orders_detail_web_orders` FOREIGN KEY (`order_id`) REFERENCES `web_orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_web_orders_detail_web_tckh_tapchi` FOREIGN KEY (`tckh_id`) REFERENCES `web_tckh_tapchi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Thong tin chi tiet don hang';

-- Dumping data for table tckh.web_orders_detail: ~0 rows (approximately)
DELETE FROM `web_orders_detail`;
/*!40000 ALTER TABLE `web_orders_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `web_orders_detail` ENABLE KEYS */;
...
-- Dumping data for table tckh.web_permissions: ~13 rows (approximately)
...
-- Dumping data for table tckh.web_roles_permissions: ~12 rows (approximately)
DELETE FROM `web_roles_permissions`;
...
-- Dumping data for table tckh.web_sessions: ~15 rows (approximately)
DELETE FROM `web_sessions`;
/*!40000 ALTER TABLE `web_sessions` DISABLE KEYS */;
INSERT INTO `web_sessions` (`id`, `payload`, `last_activity`) VALUES
	('45902c2b21acfcd628ce178b7732e36427c0092e', '', 1456294449),
	('46e23f729d8922a84b0ef2756c6d82207f20ec1a', '', 1456299212),
	('5c673129c4dc4d5859b36692b154a9a821a966fc', '', 1456295251),
	('6343e790972612edcae2ae303e53fde0e4b6065c', '', 1456298018),
	('6f78b52bc0168f6b6a60a3f861afe1a1803a4441', '', 1456300929),
	('79bb323f41f9334e0aa4a80fa1fa093385a307d9', '', 1456299224),
	('7f67a12d97bba0d217a38f0aa0c705c16f47bf9c', '', 1456297302),
	('8a59f0892287debe1f852356b6e78a7a20d38ebe', '', 1456301138),
	('a134e49b42716361fb405b3d9133d3efdf537767', '', 1456300607),
	('a8c624658af26eb0c1a5a80e3a9e2e8e68f25f65', '', 1456299412),
	('bc74d64f9d1edf34920b9fafd62c37bd0b2fd615', '', 1456298047),
	('bd848bf5e6132eeb913f8b1fa471a91d65804966', '', 1457317914),
	('d3a7bdfa48c4b11f6efa2cf56b46520e53e006bc', '', 1456294363),
	('d84d00e47e847f9d9d8f35efd338429b586dbdaa', '', 1456299360),
	('e05c558de8c1cd4cefed1de8bc845a18ff24a866', '', 1457150879),
	('ec6453852660e1189270c0ed0514daefa428f7db', '', 1456295305);
...
-- Dumping data for table tckh.web_tckh_baiviet: ~115 rows (approximately)
DELETE FROM `web_tckh_baiviet`;
/*!40000 ALTER TABLE `web_tckh_baiviet` DISABLE KEYS */;
INSERT INTO `web_tckh_baiviet` (`id`, `id_sotapchi`, `nhombaiviet`, `tenbaiviet`, `gioithieubaiviet`, `tacgia`, `sofiles`, `ngaynhap`, `usernhap`, `viewno`, `quantam`, `orderno`) VALUES
	(2, 2, 'Kinh tế', 'Nghiên  cứu  các  yếu  tố  ảnh  hưởng đến  việc  doanh  nghiệp  đầu  tư  vào khu  công  nghiệp  và  cụm  công nghiệp trên địa bàn tỉnh Tiền Giang', 'Nghiên  cứu  các  yếu  tố  ảnh  hưởng đến  việc  doanh  nghiệp  đầu  tư  vào khu  công  nghiệp  và  cụm  công nghiệp trên địa bàn tỉnh Tiền Giang', '["Nguyễn Minh Hà","Nguyễn Duy Khương"]', 1, 1432698330, 5, 0, 0, NULL),
	(3, 2, 'Kinh tế', 'Ứng dụng mô hình Hedonic để phân tích  mức  đóng  góp  của  các  thuộc  tính vào giá tour du ngoạn biển đảo một ngày tại vịnh Nha Trang', 'Ứng dụng mô hình Hedonic để phân tích  mức  đóng  góp  của  các  thuộc  tính vào giá tour du ngoạn biển đảo một ngày tại vịnh Nha Trang', '["Nguyễn Thị Thủy Tiên","Nguyễn Minh Đức"]', 1, 1432708264, 5, 0, 0, NULL),
	(4, 2, 'Kinh tế', 'Nâng cao động lực chia sẻ tri thức của các nhân viên công ty cổ phần Tư vấn xây dựng điện 3', 'Nâng cao động lực chia sẻ tri thức của các nhân viên công ty cổ phần Tư vấn xây dựng điện 3', '["Phạm Quốc Trung","Lạc Thái Phước"]', 1, 1432708666, 5, 0, 0, NULL),
	(5, 2, 'Kinh tế', 'Xây dựng mô hình đo lường sự hài lòng  của  nhân  viên  trong  công  việc tại cảng hàng không - Sân bay Pleiku', 'Xây dựng mô hình đo lường sự hài lòng  của  nhân  viên  trong  công  việc tại cảng hàng không - Sân bay Pleiku', '["Trịnh Tú Anh","Lê Thị Phương Linh"]', 1, 1432708859, 5, 0, 0, NULL),
	(6, 2, 'Khoa học công nghệ', 'Xây dựng phương pháp luận nghiên cứu  hỗ  trợ  định  danh  nấm  ký  sinh côn  trùng  bằng  phân  tích  phả  hệ phân tử vùng ITS1-5.8S-ITS2', 'Xây dựng phương pháp luận nghiên cứu  hỗ  trợ  định  danh  nấm  ký  sinh côn  trùng  bằng  phân  tích  phả  hệ phân tử vùng ITS1-5.8S-ITS2', '["Lê Huyền Ái Thúy","Đinh Minh Hiệp","Trương Bình Nguyên","Lao Đức Thuận","Trương Kim Phượng","Đỗ Ngọc Nam"]', 1, 1432708985, 5, 0, 0, NULL),
	(7, 2, 'Khoa học công nghệ', 'Nghiên cứu quy trình tách chiết beta glucan từ tế bào Saccharomyces Cerevisiae trong bã men bia', 'Nghiên cứu quy trình tách chiết beta glucan từ tế bào Saccharomyces Cerevisiae trong bã men bia', '["Lý Thị Minh Hiền","Đoàn Hạnh Kiểm","Trần Thị Thu Chi"]', 1, 1432709117, 5, 0, 0, NULL),
	(8, 2, 'Chính trị - Xã hội', 'Nâng  cao  chất  lượng  công  tác  đối ngoại  quốc  phòng  trong  điều  kiện hiện nay', 'Nâng  cao  chất  lượng  công  tác  đối ngoại  quốc  phòng  trong  điều  kiện hiện nay', '["Nguyễn Năng Nam"]', 1, 1432709339, 5, 0, 0, NULL),
	(9, 2, 'Chính trị - Xã hội', 'Tác  động  của  quá  trình  toàn  cầu hóa và hội nhập quốc tế đối với đời sống văn hóa tinh thần của giai cấp công nhân Việt Nam hiện nay', 'Tác  động  của  quá  trình  toàn  cầu hóa và hội nhập quốc tế đối với đời sống văn hóa tinh thần của giai cấp công nhân Việt Nam hiện nay', '["Phạm Thị Minh Nguyệt"]', 1, 1432709466, 5, 0, 0, NULL),
	(10, 2, 'Trao đổi học thuật và thông tin khoa học', 'Đào tạo từ xa: Thách thức ở thế kỷ 21', 'Đào tạo từ xa: Thách thức ở thế kỷ 21', '["Lê Thị Thanh Thu",""]', 1, 1432709921, 5, 0, 0, NULL),
	(11, 2, 'Trao đổi học thuật và thông tin khoa học', 'Marketing xã hội – Giải pháp kinh tế cho các vấn đề xã hội: Trường hợp công tác phòng chống HIV/AIDS và kế hoạch hóa gia đình', 'Marketing xã hội – Giải pháp kinh tế cho các vấn đề xã hội: Trường hợp công tác phòng chống HIV/AIDS và kế hoạch hóa gia đình', '["Lê Sĩ Trí",""]', 1, 1432709940, 5, 0, 0, NULL),
	(12, 3, '', 'The  effect  of  paraquat  herbicide on in vivo spermatogenesis in mice', 'The  effect  of  paraquat  herbicide on in vivo spermatogenesis in mice', '["Nguyen Nhut Vu","Nguyen Thi Thuy Hang","Nguyen Thi Bich Thao","Trinh Huu Phuoc"]', 1, 1432711038, 5, 0, 0, NULL),
	(13, 3, '', 'Establishment  of  multiplex  realtime  PCR  assay  for  simultaneous detection  of  herpes  simplex  virus and varicella-zoster virus', 'Establishment  of  multiplex  realtime  PCR  assay  for  simultaneous detection  of  herpes  simplex  virus and varicella-zoster virus', '["Lao Duc Thuan","Truong Kim Phuong","Ho Thi Thanh Thuy","Le Huyen Ai Thuy"]', 1, 1432711142, 5, 0, 0, NULL),
	(14, 3, '', 'Discorvery  of  entomopathogenic fungi  Cordyceps  takaomontana  at Langbian  mountain,  Lam  Dong, Vietnam', 'Discorvery  of  entomopathogenic fungi  Cordyceps  takaomontana  at Langbian  mountain,  Lam  Dong, Vietnam', '["Vu Tien Luyen","Trinh Van Hanh","Trinh Hoang Luan","Nguyen Thi Bich Thao","Dinh Minh Hiep","Truong Binh Nguyen","Lao Duc Thuan"]', 1, 1432711236, 5, 0, 0, NULL),
	(15, 3, '', 'Isolation  and  identification  of some  Lactobacillus  sp. strain from traditional fermented foods', 'Isolation  and  identification  of some  Lactobacillus  sp. strain from traditional fermented foods', '["Truong Kim Phuong","Nguyen Trong Nghia","Le Huyen Ai Thuy"]', 1, 1432711308, 5, 0, 0, NULL),
	(16, 3, '', 'EGFR  and  K-RAS  in  molecularly targeted  therapy:  from  in  silico  to in vitro study', 'EGFR  and  K-RAS  in  molecularly targeted  therapy:  from  in  silico  to in vitro study', '["Lieu Chi Hung","Lao Duc Thuan","Le Huyen Ai Thuy"]', 1, 1432711429, 5, 0, 0, NULL),
	(17, 3, '', 'Avoidance of multiple oviposition in Meteorus pulchricornis (hymenoptera: braconidae)', 'Avoidance of multiple oviposition in Meteorus pulchricornis (hymenoptera: braconidae)', '["Nguyen Ngoc Bao Chau "]', 1, 1432711472, 5, 0, 0, NULL),
	(18, 3, '', 'Literature review of climate change impact induced migration', 'Literature review of climate change impact induced migration', '["Do Thi Kim Chi"]', 1, 1432711510, 5, 0, 0, NULL),
	(19, 4, 'Kinh tế', 'Mô hình Oaxaca - Blinder trong phân tích kinh tế', 'Mô hình Oaxaca - Blinder trong phân tích kinh tế', '["Lê Bảo Lâm","Nguyễn Minh Hà","Lê Văn Hưởng"]', 1, 1434967089, 38, 0, 0, NULL),
	(20, 4, 'Kinh tế', 'Ảnh hưởng của thu nhập và giá cả đến chi tiêu cho thực phẩm của các hộ gia đình Việt Nam', 'Ảnh hưởng của thu nhập và giá cả đến chi tiêu cho thực phẩm của các hộ gia đình Việt Nam', '["Nguyễn Hữu Dũng","Nguyễn Ngọc Thuyết"]', 1, 1434967761, 38, 0, 0, NULL),
	(21, 4, 'Kinh tế', 'Tác động của các yếu tố quản lý đến hiệu suất của doanh nghiệp xuất khẩu thủy sản tỉnh Bà Rịa-Vũng Tàu', 'Tác động của các yếu tố quản lý đến hiệu suất của doanh nghiệp xuất khẩu thủy sản tỉnh Bà Rịa-Vũng Tàu', '["Trần Hữu Ái","Nguyễn Minh Đức"]', 1, 1434967943, 38, 0, 0, NULL),
	(22, 4, 'Kinh tế', 'Cảm nhận giá trị và sự gắn kết nhân viên tại các công ty Kiểm toán trên địa bàn Thành Phố Hồ Chí Minh', 'Cảm nhận giá trị và sự gắn kết nhân viên tại các công ty Kiểm toán trên địa bàn Thành Phố Hồ Chí Minh', '["Nguyễn Thế Khải","Đỗ Thị Thanh Trúc"]', 1, 1434968041, 38, 0, 0, NULL),
	(23, 4, 'Kinh tế', 'Chất lượng nhân viên bán hàng, bảo hành và giá trị thương hiệu trong ngành bán lẻ kim khí điện máy', 'Chất lượng nhân viên bán hàng, bảo hành và giá trị thương hiệu trong ngành bán lẻ kim khí điện máy', '["Lê Tấn Bửu","Lê Đăng Lăng"]', 1, 1435023438, 38, 0, 0, NULL),
	(24, 4, 'Kinh tế', 'Phân cấp đề tài khóa và tăng trưởng kinh tế: Minh chứng ở Việt Nam', 'Phân cấp tài khóa và tăng trưởng kinh tế: Minh chứng ở Việt Nam', '["Trần Phạm Khánh Toàn",""]', 1, 1435030509, 38, 0, 0, NULL),
	(25, 4, 'Kinh tế', 'Mối quan hệ "Tiến-Thoái" giữa Việt Nam và các nướn Asean-4', 'Mối quan hệ "Tiến-Thoái" giữa Việt Nam và các nướn Asean-4', '["Lâm Trí Dũng","Lê Sĩ Trí","Trần Nha Ghi"]', 1, 1435030596, 38, 0, 0, NULL),
	(26, 4, 'Giáo dục', 'Nguồn lực tương tác, hành vi hướng tới người học và vai tròn đồng tạo sinh giá trị của học viên trong dịch vụ đào tạo', 'Nguồn lực tương tác, hành vi hướng tới người học và vai tròn đồng tạo sinh giá trị của học viên trong dịch vụ đào tạo', '["Hồ Hoàng Diệu","Phạm Ngọc Thúy"]', 1, 1435030755, 38, 0, 0, NULL),
	(27, 4, 'Giáo dục', 'Chiến lược phát triển của trường đại học ngoài công lập: Nghiên cứu trường hợp Trường Đại học Đông Á-Đà Nẵng', 'Chiến lược phát triển của trường đại học ngoài công lập: Nghiên cứu trường hợp Trường Đại học Đông Á-Đà Nẵng', '["Nhâm Phong Tuân","Đặng Thị Kim Thoa"]', 1, 1435030930, 38, 0, 0, NULL),
	(28, 4, 'Khoa học Kỹ thuật', 'Phân tích phi tuyến khung dàn thép phẳng sử dụng phương pháp dầm-cột', 'Phân tích phi tuyến khung dàn thép phẳng sử dụng phương pháp dầm-cột', '["Đặng Thị Phương Uyên","Lê Thanh Cường","Ngô Hữu Cường"]', 1, 1435031627, 38, 0, 0, NULL),
	(29, 4, 'Trao đổi học thuật và thông tin khoa học', 'Quản lý nợ công tại Việt Nam nhìn từ thông lệ quốc tế và một số khủng hoảng nợ công trên thế giới', 'Quản lý nợ công tại Việt Nam nhìn từ thông lệ quốc tế và một số khủng hoảng nợ công trên thế giới', '["Nguyễn Quốc Toản"]', 1, 1435031732, 38, 0, 0, NULL),
	(30, 5, 'ECONOMICS', 'Interest  rate  pass- through  estimates from error correction models ECM', 'Interest  rate  pass- through  estimates from error correction models ECM', '["Le Phan Thi Dieu Thao","Nguyen Thi Thu Trang"]', 1, 1435051796, 38, 0, 0, NULL),
	(31, 5, 'ECONOMICS', 'An assessment of multidimensional urban  poverty  in  Vietnam  central cities', 'An assessment of multidimensional urban  poverty  in  Vietnam  central cities', '["Nguyen Huu Dung","Nguyen Van Cuong"]', 1, 1435051871, 38, 0, 0, NULL),
	(32, 5, 'ECONOMICS', 'Government’s  and  professional associations’  roles  in  promoting corporate  social  resposibility  – An  exploratory in  Vietnamese construction firms', 'Government’s  and  professional associations’  roles  in  promoting corporate  social  resposibility  – An  exploratory in  Vietnamese construction firms', '["Le Thi Thanh Xuan","Tran Tien Khoa"]', 1, 1435051994, 38, 0, 0, NULL),
	(33, 5, 'ECONOMICS', 'Assessing the development potential of modern retail in Vietnam', 'Assessing the development potential of modern retail in Vietnam', '["Tran Tuan Anh"]', 1, 1435052042, 38, 0, 0, NULL),
	(34, 5, 'ECONOMICS', 'Customer satisfaction and customer loyalty  in  Vietnamese  mobile telecommunication industry', 'Customer satisfaction and customer loyalty  in  Vietnamese  mobile telecommunication industry', '["Trinh Kim Hoa","Luu Thi Bich Ngoc"]', 1, 1435052097, 38, 0, 0, NULL),
	(35, 5, 'EDUCATION', 'Common  errors  in  writing  journals of  the  english-major  students  at  Ho Chi Minh City   Open University', 'Common  errors  in  writing  journals of  the  english-major  students  at  Ho Chi Minh City   Open University', '["Pham Vu Phi Ho","Pham Ngoc Thuy Duong"]', 1, 1435052163, 38, 0, 0, NULL),
	(36, 5, 'EDUCATION', 'Student  -   teachers’  self- assessment of their autonomy', 'Student  -   teachers’  self- assessment of their autonomy', '["Phan Thi Thu Nga"]', 1, 1435053814, 38, 0, 0, NULL),
	(37, 5, 'TECHNOLOGY', 'Experimental studies on ingredients of  composite  soil  for  a  higher strength backfill material', 'Experimental studies on ingredients of  composite  soil  for  a  higher strength backfill material', '["Duong Hong Tham","Truong Dinh Duong","Huynh Huu Minh Dang","Le Huyen Thoai"]', 1, 1435053896, 38, 0, 0, NULL),
	(38, 5, 'TECHNOLOGY', 'The family braconidae (hymenoptera) parasitoids: Taxonomy and behavior', 'The family braconidae (hymenoptera) parasitoids: Taxonomy and behavior', '["Nguyen Ngoc Bao Chau","Nguyen Bao Quoc"]', 1, 1435053973, 38, 0, 0, NULL),
	(39, 5, 'ACADEMIC EXCHANGE AND SCIENTIFIC INFORMATION', 'Evaluation use and influence – A review of related literature', 'Evaluation use and influence – A review of related literature', '["Ha Minh Tri"]', 1, 1435054026, 38, 0, 0, NULL),
	(40, 6, 'Kinh tế', 'Đi tìm giá trị hợp lý của các cổ phiếu hàng đầu trên sàn giao dịch chứng khoán  Thành phố Hồ Chí Minh (Hose)', 'Đi tìm giá trị hợp lý của các cổ phiếu hàng đầu trên sàn giao dịch chứng khoán  Thành phố Hồ Chí Minh (Hose)', '["Vương Đức Hoàng Quân"]', 1, 1435915245, 38, 0, 0, NULL),
	(41, 6, 'Kinh tế', 'Yếu  tố  chuyển  giao  của  hoạt  động  nhượng quyền thương mại trong lĩnh vực ăn uống-giải khát: Trường hợp nghiên cứu tại Việt Nam', 'Yếu  tố  chuyển  giao  của  hoạt  động  nhượng quyền thương mại trong lĩnh vực ăn uống-giải khát: Trường hợp nghiên cứu tại Việt Nam', '["Nguyễn Khánh Trung "]', 1, 1435915413, 38, 0, 0, NULL),
	(42, 6, 'Kinh tế', 'Lòng  trung  thành  thương  hiệu  trong  mối quan  hệ  B2B:  Trường  hợp  sản  phẩm  thuốc bảo vệ thực vật tại đồng bằng sông Cửu Long', 'Lòng  trung  thành  thương  hiệu  trong  mối quan  hệ  B2B:  Trường  hợp  sản  phẩm  thuốc bảo vệ thực vật tại đồng bằng sông Cửu Long', '["Hoàng Thị Phương Thảo","Nguyễn Công Phục"]', 1, 1435915610, 38, 0, 0, NULL),
	(43, 6, 'Kinh tế', 'Mối quan hệ giữa hành vi của Bác sĩ với sự tin tưởng, hài lòng và lòng trung thành của bệnh  nhân  -  Một  nghiên  cứu  tại  các  bệnh viện tỉnh Lâm Đồng', 'Mối quan hệ giữa hành vi của Bác sĩ với sự tin tưởng, hài lòng và lòng trung thành của bệnh  nhân  -  Một  nghiên  cứu  tại  các  bệnh viện tỉnh Lâm Đồng', '["Nguyễn Thúy Quỳnh Loan","Lê Quang Vinh"]', 1, 1435915704, 38, 0, 0, NULL),
	(44, 6, 'Kinh tế', 'Tổng  quan  cơ  sở  khoa  học  cho  phát  triểnnông thôn bền vững ở Việt Nam', 'Tổng  quan  cơ  sở  khoa  học  cho  phát  triểnnông thôn bền vững ở Việt Nam', '["Trần Tiến Khai"]', 1, 1435915833, 38, 0, 0, NULL),
	(45, 6, 'Kinh tế', 'Có  tiền  vẫn  chưa  đủ:  Vai  trò  của  sự  tham gia của khách hàng trong quá trình đồng tạo sinh  dịch  vụ  và  cảm  nhận  giá  trị.  Một nghiên cứu trong ngành đào tạo Đại học', 'Có  tiền  vẫn  chưa  đủ:  Vai  trò  của  sự  tham gia của khách hàng trong quá trình đồng tạo sinh  dịch  vụ  và  cảm  nhận  giá  trị.  Một nghiên cứu trong ngành đào tạo Đại học', '["Mai Thị Mỹ Quyên","Lê Nguyễn Hậu"]', 1, 1435915979, 38, 0, 0, NULL),
	(46, 6, 'Kinh tế', 'Mô  hình  lý  thuyết  về  hiệu  quả  đội  trong doanh nghiệp Việt Nam', 'Mô  hình  lý  thuyết  về  hiệu  quả  đội  trong doanh nghiệp Việt Nam', '["Huỳnh Thị Minh Châu","Trương Thị Lan Anh","Nguyễn Mạnh Tuân"]', 1, 1435916074, 38, 0, 0, NULL),
	(47, 6, 'Kinh tế', 'Kinh tế ngầm & tham nhũng tại các quốc gia Đông Nam Á', 'Kinh tế ngầm & tham nhũng tại các quốc gia Đông Nam Á', '["Võ Hồng Đức","Lý Hưng Thịnh"]', 1, 1435916138, 38, 0, 0, NULL),
	(48, 6, 'Kinh tế', 'Tiền tố và hậu tố của chất lượng mối quan hệ giữa người trồng hoa công nghệ cao với nhà phân phối tại Đà Lạt', 'Tiền tố và hậu tố của chất lượng mối quan hệ giữa người trồng hoa công nghệ cao với nhà phân phối tại Đà Lạt', '["Trần Thị Lam Phương","Sử Thị Oanh Hoa","Phạm Ngọc Thúy",""]', 1, 1435916354, 38, 0, 0, NULL),
	(49, 6, 'Kinh tế', 'Ảnh hưởng của chính sách vốn lưu động đến hiệu quả hoạt động của các công ty niêm yết trên thị trường chứng khoán Việt Nam', 'Ảnh hưởng của chính sách vốn lưu động đến hiệu quả hoạt động của các công ty niêm yết trên thị trường chứng khoán Việt Nam', '["Tô Thị Thanh Trúc","Nguyễn Đình Thiên"]', 1, 1435916430, 38, 0, 0, NULL),
	(50, 6, 'Kinh tế', 'Định  hướng  giá  trị  khi  đi  mua  sắm  của người tiêu dùng đối với các kênh phân phối hiện  đại:  Một  nghiên  cứu  tại  các  siêu  thị điện máy Thành phố Hồ Chí Minh', 'Định  hướng  giá  trị  khi  đi  mua  sắm  của người tiêu dùng đối với các kênh phân phối hiện  đại:  Một  nghiên  cứu  tại  các  siêu  thị điện máy Thành phố Hồ Chí Minh', '["Hứa Kiều Phương Mai","Lê Phước Luông","Lê Nguyễn Hậu"]', 1, 1435916523, 38, 0, 0, NULL),
	(51, 6, 'Kinh tế', 'Vai trò của du lịch đối với tăng trưởng kinh tế Việt Nam', 'Vai trò của du lịch đối với tăng trưởng kinh tế Việt Nam', '["Nguyễn Quyết","Võ Thanh Hải"]', 1, 1435916621, 38, 0, 0, NULL),
	(52, 6, 'Kinh tế', 'Các rào cản thương mại khi xuất khẩu thủy sản vào thị trường quốc tế', 'Các rào cản thương mại khi xuất khẩu thủy sản vào thị trường quốc tế', '["Trần Hữu Ái"]', 1, 1435916688, 38, 0, 0, NULL),
	(53, 6, 'Trao đổi học thuật và thông tin khoa học', 'Sự khác biệt của tiêu chuẩn ISO 9001:2015', 'Sự khác biệt của tiêu chuẩn ISO 9001:2015', '["Hoàng Mạnh Dũng","Trịnh Tuấn Dũng"]', 1, 1435916755, 38, 0, 0, NULL),
	(54, 6, 'Trao đổi học thuật và thông tin khoa học', 'Bàn về thuật ngữ “văn bản pháp luật” trong hệ thống pháp luật Việt Nam', 'Bàn về thuật ngữ “văn bản pháp luật” trong hệ thống pháp luật Việt Nam', '["Trần Thị Mai Phước"]', 1, 1435916863, 38, 0, 0, NULL),
	(55, 6, 'Trao đổi học thuật và thông tin khoa học', 'Kinh  nghiệm  phát  triển  năng  lượng  tái tạo  của  Trung  Quốc  và  bài  học  đối  với Việt Nam', 'Kinh  nghiệm  phát  triển  năng  lượng  tái tạo  của  Trung  Quốc  và  bài  học  đối  với Việt Nam', '["Nguyễn Hùng Cường"]', 1, 1435916918, 38, 0, 0, NULL),
	(56, 7, 'Kinh tế', 'Tìm hiểu lịch sử tăng trưởng kinh tế thế giới trong 2000 năm', 'Tìm hiểu lịch sử tăng trưởng kinh tế thế giới trong 2000 năm', '["Nguyễn Văn Phúc"]', 1, 1437971311, 38, 0, 0, NULL),
	(57, 7, 'Kinh tế', 'Các yếu tố tác động đến thù lao Hội đồng quản trị: Bằng chứng từ các công ty niêm yết ở Sở giao dịch chứng khoán TP.HCM', 'Các yếu tố tác động đến thù lao Hội đồng quản trị: Bằng chứng từ các công ty niêm yết ở Sở giao dịch chứng khoán TP.HCM', '["Võ Hồng Đức","Hoàng Đình Sơn","Phan Bùi Gia Thủy"]', 1, 1437971467, 38, 0, 0, NULL),
	(58, 7, 'Kinh tế', 'Mô  hình  toán  thiết  kế  chuỗi  cung  ứng: Xem xét công suất vận hành của các đơn vị kinh doanh', 'Mô  hình  toán  thiết  kế  chuỗi  cung  ứng: Xem xét công suất vận hành của các đơn vị kinh doanh', '["Đường Võ Hùng","Bùi Nguyên Hùng"]', 1, 1437971515, 38, 0, 0, NULL),
	(59, 7, 'Kinh tế', 'Xây dựng và vận dụng hệ thống đánh giá năng  lực  nhân  viên  để  đề  xuất  chương trình đào tạo phù hợp', 'Xây dựng và vận dụng hệ thống đánh giá năng  lực  nhân  viên  để  đề  xuất  chương trình đào tạo phù hợp', '["Trần Minh Thư","Bùi Văn Dự"]', 1, 1437971599, 38, 0, 0, NULL),
	(60, 7, 'CHÍNH TRỊ-GIÁO DỤC-VĂN HÓA-XÃ HỘI', 'Phát huy chủ nghĩa yêu nước Việt Nam trong thời kỳ đẩy mạnh công nghiệp hóa, hiện đại hóa', 'Phát huy chủ nghĩa yêu nước Việt Nam trong thời kỳ đẩy mạnh công nghiệp hóa, hiện đại hóa', '["Nguyễn Năng Nam","Nguyễn Đình Bắc",""]', 1, 1437971772, 38, 0, 0, NULL),
	(61, 7, 'CHÍNH TRỊ-GIÁO DỤC-VĂN HÓA-XÃ HỘI', '“Lộn trái” một hình tượng mở lối mới tìm hiểu tư tưởng chủ đề Nho lâm Ngoại sử', '“Lộn trái” một hình tượng mở lối mới tìm hiểu tư tưởng chủ đề Nho lâm Ngoại sử', '["Lê Thời Tân"]', 1, 1437971838, 38, 0, 0, NULL),
	(62, 7, 'CHÍNH TRỊ-GIÁO DỤC-VĂN HÓA-XÃ HỘI', 'Xây dựng nông thôn mới ở vùng người Khmer:  Thách  thức  của  sự  nghèo  đói, sinh kế và di cư', 'Xây dựng nông thôn mới ở vùng người Khmer:  Thách  thức  của  sự  nghèo  đói, sinh kế và di cư', '["Phạm Thanh Thôi",""]', 1, 1437973342, 38, 0, 0, NULL),
	(63, 7, 'CHÍNH TRỊ-GIÁO DỤC-VĂN HÓA-XÃ HỘI', 'Tại sao sinh viên từ xa Trường Đại Học Mở Thành Phố Hồ Chí Minh bỏ học?', 'Tại sao sinh viên từ xa Trường Đại Học Mở Thành Phố Hồ Chí Minh bỏ học?', '["Lê Thị Thanh Thu"]', 1, 1437973422, 38, 0, 0, NULL),
	(64, 7, 'CHÍNH TRỊ-GIÁO DỤC-VĂN HÓA-XÃ HỘI', 'Luận văn tốt nghiệp đại học ngành quản trị – cách tiếp cận từ phương pháp định tính 93', 'Luận văn tốt nghiệp đại học ngành quản trị – cách tiếp cận từ phương pháp định tính 93', '["Trần Tiến Khoa","Lê Thị Thanh Xuân"]', 1, 1437973482, 38, 0, 0, NULL),
	(65, 7, 'Khoa học Kỹ thuật', 'Phân tích sự hiệu quả giảm chấn của gối trượt ma sát kết hợp hệ cản lưu biến từ nối giữa hai kết cấu chịu động đất', 'Phân tích sự hiệu quả giảm chấn của gối trượt ma sát kết hợp hệ cản lưu biến từ nối giữa hai kết cấu chịu động đất', '["Phạm Đình Trung","Nguyễn Văn Nam","Nguyễn Trọng Phước"]', 1, 1437973556, 38, 0, 0, NULL),
	(66, 8, 'Kinh tế', 'Văn hóa ảnh hưởng gián tiếp lên hành vi tiêu dùng: Một tổng lược lý thuyết', 'Văn hóa ảnh hưởng gián tiếp lên hành vi tiêu dùng: Một tổng lược lý thuyết', '["Nguyễn Văn Phúc","Nguyễn Đình Trọng"]', 1, 1438936287, 38, 0, 0, NULL),
	(67, 8, 'Kinh tế', 'Các nhân tố tác động đến hiệu quả sản xuất  của  doanh  nghiệp  vừa  và  nhỏ  tại Việt Nam', 'Các nhân tố tác động đến hiệu quả sản xuất  của  doanh  nghiệp  vừa  và  nhỏ  tại Việt Nam', '["Võ Hồng Đức","Lê Hoàng Long"]', 1, 1438936740, 38, 0, 0, NULL),
	(68, 8, 'Kinh tế', 'Ý định thuê văn phòng ảo của các doanh nghiệp nhỏ và vừa', 'Ý định thuê văn phòng ảo của các doanh nghiệp nhỏ và vừa', '["Bùi Thanh Tráng",""]', 1, 1438937164, 38, 0, 0, NULL),
	(69, 8, 'Kinh tế', 'Phân tích lợi ích tài chính của chuỗi giá trị bưởi Da xanh tỉnh Bến Tre', 'Phân tích lợi ích tài chính của chuỗi giá trị bưởi Da xanh tỉnh Bến Tre', '["Hoàng Văn Việt"]', 1, 1438937317, 38, 0, 0, NULL),
	(70, 8, 'Kinh tế', 'Quan hệ của viện trợ nước ngoài và tăng trưởng kinh tế thực tiễn tại Việt Nam', 'Quan hệ của viện trợ nước ngoài và tăng trưởng kinh tế thực tiễn tại Việt Nam', '["Nguyễn Quyết"]', 1, 1438937433, 38, 0, 0, NULL),
	(71, 8, 'Chính trị - Xã hội', 'Tư tưởng Hồ Chí Minh về bình đẳng dân tộc ở Việt Nam', 'Tư tưởng Hồ Chí Minh về bình đẳng dân tộc ở Việt Nam', '["Nguyễn Năng Nam","Trần Minh Quốc"]', 1, 1438937491, 38, 0, 0, NULL),
	(72, 8, 'Chính trị - Xã hội', 'Hiện trạng và khả năng tiếp cận phúc lợi xã  hội  của  người  công  nhân  đang  làm việc  tại  các  khu  công  nghiệp  tỉnh  Bình Dương, Việt Nam', 'Hiện trạng và khả năng tiếp cận phúc lợi xã  hội  của  người  công  nhân  đang  làm việc  tại  các  khu  công  nghiệp  tỉnh  Bình Dương, Việt Nam', '["Nguyễn Đức Lộc"]', 1, 1438937546, 38, 0, 0, NULL),
	(73, 8, 'Khoa học Kỹ thuật', 'Phân tích ổn định của tấm FGMsử dụng lý thuyết biến dạng cắt bậc cao', 'Phân tích ổn định của tấm FGMsử dụng lý thuyết biến dạng cắt bậc cao', '["Ngô Phát Đạt","Ngô Thành Phong","Trần Trung Dũng"]', 1, 1438937607, 38, 0, 0, NULL),
	(74, 8, 'GIỚI THIỆU SÁCH', 'Làng Việt – Đối diện tương lai hồi sinh quá khứ', 'Làng Việt – Đối diện tương lai hồi sinh quá khứ', '["Lê Minh Tiến"]', 1, 1438937708, 38, 0, 0, NULL),
	(75, 8, 'THÔNG TIN HOẠT ĐỘNG KHOA HỌC', 'Sinh  viên  nghiên  cứu  khoa  học Trường Đại Học Mở Tp.HCM năm học 2012-2013', 'Sinh  viên  nghiên  cứu  khoa  học Trường Đại Học Mở Tp.HCM năm học 2012-2013', '["Huỳnh Thị Kim Tuyết"]', 1, 1438937760, 38, 0, 0, NULL),
	(76, 9, 'Công nghệ', 'Bước đầu xây dựng quy trình PCR nhằm phát hiện thành phần động vật trong thực phẩm  chay  dựa  trên  vùng  16S  rDNA  ty thể', 'Bước đầu xây dựng quy trình PCR nhằm phát hiện thành phần động vật trong thực phẩm  chay  dựa  trên  vùng  16S  rDNA  ty thể', '["Lao Đức Thuận","Nguyễn Thị Thanh Nhàn","Nguyễn Thị Thiên Hương","Trần Kiến Đức","Võ Phi Phi Nguyên","Phan Thi Trâm","Lê Huyền Ái Thúy"]', 1, 1438939173, 38, 0, 0, NULL),
	(77, 9, 'Công nghệ', 'Khảo  sát  tác  dụng  hạ  đường  huyết  của một số loại thảo dược trên mô hình chuột In Vivo', 'Khảo  sát  tác  dụng  hạ  đường  huyết  của một số loại thảo dược trên mô hình chuột In Vivo', '["Hồ Thị Huyền Trang","Phạm Thị Ngọc Bích","Phạm Xuân Xinh","Trương Thị Bạch Vân","Vũ Tiến Luyện","Lao Đức Thuận"]', 1, 1438939255, 38, 0, 0, NULL),
	(78, 9, 'Công nghệ', 'Khảo sát thiên địch và sâu hại rau  ở  một số  vườn rau canh tác an toàn huyện  Hóc Môn  và  đánh  giá  khá  năng  ký  sinh  của ong ký sinh Cotesia plutellae Kurdjumov', 'Khảo sát thiên địch và sâu hại rau  ở  một số  vườn rau canh tác an toàn huyện  Hóc Môn  và  đánh  giá  khá  năng  ký  sinh  của ong ký sinh Cotesia plutellae Kurdjumov', '["Cao Hoàng Yến Nhi","Lê Thị Bích Liên","Đặng Thị Kim Chi","Trương Thành Đạt","Nguyễn Thị Thanh Thảo","Trịnh Đức Thịnh","Đặng Thị Tình","Nguyễn Thanh Bạch","Trần Hậu Toàn","Nguyễn Đức Nam","Nguyễn Ngọc Bảo Châu"]', 1, 1438939382, 38, 0, 0, NULL),
	(79, 9, 'Kinh tế', 'Kiểm định đồng liên kết giữa giá cà phê Việt Nam xuất khẩu và giá cà phê thế giới giai đoạn 2008 -2014', 'Kiểm định đồng liên kết giữa giá cà phê Việt Nam xuất khẩu và giá cà phê thế giới giai đoạn 2008 -2014', '["Nguyễn Văn Phúc","Tô Thị Kim Hồng"]', 1, 1438939438, 38, 0, 0, NULL),
	(80, 9, 'Kinh tế', 'Yếu tố quyết định tỷ lệ an toàn vốn: Bằng chứng  thực  nghiệm  từ  hệ  thống  Ngân hàng Thương Mại Việt Nam', 'Yếu tố quyết định tỷ lệ an toàn vốn: Bằng chứng  thực  nghiệm  từ  hệ  thống  Ngân hàng Thương Mại Việt Nam', '["Võ Hồng Đức","Nguyễn Minh Vương","Đỗ Thành Trung"]', 1, 1438939497, 38, 0, 0, NULL),
	(81, 9, 'Kinh tế', 'Ảnh  hưởng  của  phong  cách  lãnh  đạo người  Nhật  đến  kết  quả  làm  việc của  nhân  viên  tại  các  công  ty  Nhật  ở Việt Nam', 'Ảnh  hưởng  của  phong  cách  lãnh  đạo người  Nhật  đến  kết  quả  làm  việc của  nhân  viên  tại  các  công  ty  Nhật  ở Việt Nam', '["Nguyễn Minh Hà","Phạm Thế Khánh","Lê Khoa Huân"]', 1, 1438939558, 38, 0, 0, NULL),
	(82, 9, 'Kinh tế', 'Tác  động  của  hoạt  động  quản  trị  nguồn nhân lực đối với độ hài lòng  trong công việc và hiệu quả công việc', 'Tác  động  của  hoạt  động  quản  trị  nguồn nhân lực đối với độ hài lòng  trong công việc và hiệu quả công việc', '["Lưu Thị Bích Ngọc","Lưu Hoàng Mai"]', 1, 1438939637, 38, 0, 0, NULL),
	(83, 9, 'Kinh tế', 'Giải  pháp  tăng  hiệu  quả  sản  xuất  tôm càng xanh tại tỉnh Đồng Tháp', 'Giải  pháp  tăng  hiệu  quả  sản  xuất  tôm càng xanh tại tỉnh Đồng Tháp', '["Nguyễn Kim Phước",""]', 1, 1438939689, 38, 0, 0, NULL),
	(84, 9, 'TRAO ĐỔI HỌC THUẬT', 'Định  hướng  phát  triển  thị  trường  chứng khoán phái sinh ở nước ta', 'Định  hướng  phát  triển  thị  trường  chứng khoán phái sinh ở nước ta', '["Thái Đắc Liệt"]', 1, 1438939738, 38, 0, 0, NULL),
	(85, 9, 'GIỚI THIỆU SÁCH', 'Thế giới như tôi thấy', 'Thế giới như tôi thấy', '["Nguyễn Thị Ngọc Tú"]', 1, 1438939790, 38, 0, 0, NULL),
	(86, 10, 'Kinh tế', 'Khủng  hoảng  nợ  công  châu  Âu  và bài học cho Việt Nam', 'Khủng  hoảng  nợ  công  châu  Âu  và bài học cho Việt Nam', '["Nguyễn Văn Phúc"]', 1, 1439002374, 38, 0, 0, NULL),
	(87, 10, 'Kinh tế', 'Các yếu tố ảnh hưởng đến thời gian gắn  kết  của  giáo  viên  cơ  hữu  tại Trường  PTTH  ngoài  công  lập  trên địa bàn TP.HCM', 'Các yếu tố ảnh hưởng đến thời gian gắn  kết  của  giáo  viên  cơ  hữu  tại Trường  PTTH  ngoài  công  lập  trên địa bàn TP.HCM', '["Nguyễn Nguyên Bằng","Nguyễn Minh Hà","Lê Khoa Huân"]', 1, 1439002495, 38, 0, 0, NULL),
	(88, 10, 'Kinh tế', 'Trách  nhiệm  xã  hội  của  doanh nghiệp  từ  nhận  thức  của  sinh  viên đại học', 'Trách  nhiệm  xã  hội  của  doanh nghiệp  từ  nhận  thức  của  sinh  viên đại học', '["Nguyễn Đình Hải","Trần Tiến Khoa","Lê Thị Thanh Xuân"]', 1, 1439002567, 38, 0, 0, NULL),
	(89, 10, 'Kinh tế', 'Danh tiếng tổ chức đào tạo theo góc nhìn học viên cao học', 'Danh tiếng tổ chức đào tạo theo góc nhìn học viên cao học', '["Hoàng Thị Phương Thảo"]', 1, 1439002621, 38, 0, 0, NULL),
	(90, 10, 'Kinh tế', 'Các  yếu  tố  ảnh  hưởng  đến  quyết định  chọn  dịch  vụ  hỗ  trợ  tuyển dụng  nhân  sự  cao  cấp  của  các doanh nghiệp TP.HCM', 'Các  yếu  tố  ảnh  hưởng  đến  quyết định  chọn  dịch  vụ  hỗ  trợ  tuyển dụng  nhân  sự  cao  cấp  của  các doanh nghiệp TP.HCM', '["Nguyễn Minh Nhật","Lại Văn Tài"]', 1, 1439002684, 38, 0, 0, NULL),
	(91, 10, 'Kinh tế', 'Quan  hệ  giữa  tăng  trưởng  kinh  tế và  tiêu  thụ  điện  năng  thực  tiễn  tại Việt Nam', 'Quan  hệ  giữa  tăng  trưởng  kinh  tế và  tiêu  thụ  điện  năng  thực  tiễn  tại Việt Nam', '["Nguyễn Quyết","Vũ Quốc Khánh"]', 1, 1439002770, 38, 0, 0, NULL),
	(92, 10, 'CHÍNH TRỊ - GIÁO DỤC  - XÃ HỘI', 'Tổng  quan  những  nghiên  cứu  đa ngành về lễ hội: Đề xuất hướng tiếp cận liên ngành trong bối cảnh đô thị ', 'Tổng  quan  những  nghiên  cứu  đa ngành về lễ hội: Đề xuất hướng tiếp cận liên ngành trong bối cảnh đô thị ', '["Phạm Thanh Thôi"]', 1, 1439002891, 38, 0, 0, NULL),
	(93, 10, 'CHÍNH TRỊ - GIÁO DỤC  - XÃ HỘI', 'Những hạn chế trong phương pháp dạy  và  học  môn  Viết  tại  Khoa Ngoại  ngữ  Trường  Đại  học  Mở TP.HCM', 'Những hạn chế trong phương pháp dạy  và  học  môn  Viết  tại  Khoa Ngoại  ngữ  Trường  Đại  học  Mở TP.HCM', '["Phạm Vũ Phi Hổ"]', 1, 1439002950, 38, 0, 0, NULL),
	(94, 10, 'CHÍNH TRỊ - GIÁO DỤC  - XÃ HỘI', 'Đo lường kết quả đọc âm cuối tiếng Anh  của  sinh  viên  năm  1,  khoá 2011  chuyên  ngành  tiếng  Anh  tạiTrường Đại học Mở TP.HCM', 'Đo lường kết quả đọc âm cuối tiếng Anh  của  sinh  viên  năm  1,  khoá 2011  chuyên  ngành  tiếng  Anh  tạiTrường Đại học Mở TP.HCM', '["Nguyễn Thị Hoài Minh","Nguyễn Vũ Phương Thảo"]', 1, 1439003049, 38, 0, 0, NULL),
	(95, 10, 'CHÍNH TRỊ - GIÁO DỤC  - XÃ HỘI', 'Vài  nét  về  nghệ  thuật  chiến  dịch trong  chiến  tranh  nhân  dân Việt Nam', 'Vài  nét  về  nghệ  thuật  chiến  dịch trong  chiến  tranh  nhân  dân Việt Nam', '["Nguyễn Anh Cường"]', 1, 1439003146, 38, 0, 0, NULL),
	(96, 11, 'Kinh tế', 'Các nhân tố ảnh hưởng đến sự thành công của các dự án hệ thống thông tin ở TP.HCM', 'Các nhân tố ảnh hưởng đến sự thành công của các dự án hệ thống thông tin ở TP.HCM', '["Nguyễn Văn Phúc","Phạm Trần Sĩ Lâm"]', 1, 1439521779, 38, 0, 0, NULL),
	(97, 11, 'Kinh tế', 'Một số nhân tố ảnh hưởng đến lòng trung thành của khách hàng: Một nghiên cứu về dịch vụ hàng không nội địa ở Việt Nam', 'Một số nhân tố ảnh hưởng đến lòng trung thành của khách hàng: Một nghiên cứu về dịch vụ hàng không nội địa ở Việt Nam', '["Dương Thanh Truyền","Nguyễn Thị Mai Trang"]', 1, 1439521910, 38, 0, 0, NULL),
	(98, 11, 'Kinh tế', 'Nhìn lại quá trình chuyển dịch cơ cấu kinh tế trên địa bàn TP.HCM', 'Nhìn lại quá trình chuyển dịch cơ cấu kinh tế trên địa bàn TP.HCM', '["Vương Đức Hoàng Quân"]', 0, 1439522050, 38, 0, 0, NULL),
	(99, 11, 'Kinh tế', 'Rủi ro trong các dự án xây dựng công trình giao thông ở Việt Nam', 'Rủi ro trong các dự án xây dựng công trình giao thông ở Việt Nam', '["Trịnh Thùy Anh"]', 1, 1439525285, 38, 0, 0, NULL),
	(100, 11, 'Kinh tế', 'Ảnh hưởng của toàn cầu hóa kinh tế và tăng trưởng kinh tế lên tỷ lệ thất nghiệp: Thực tiễn tại Việt Nam', 'Ảnh hưởng của toàn cầu hóa kinh tế và tăng trưởng kinh tế lên tỷ lệ thất nghiệp: Thực tiễn tại Việt Nam', '["Nguyễn Quyết"]', 1, 1439525601, 38, 0, 0, NULL),
	(101, 11, 'Công nghệ', 'Khảo sát In Silico, xây dựng cơ sở khoa học cho việc phát hiện kết hợp yếu tố nhiễm và bất ổn di truyền trong ưng thu vòm họng', 'Khảo sát In Silico, xây dựng cơ sở khoa học cho việc phát hiện kết hợp yếu tố nhiễm và bất ổn di truyền trong ưng thu vòm họng', '["Nguyễn Văn Trường","Nguyễn Thị Thúy Tài","Nguyễn Thị Thanh Nhàn","Nguyễn Thị Thu Ngân","Lý Thị Tuyết Ngọc","Lao Đức Thuận"]', 1, 1439525765, 38, 0, 0, NULL),
	(102, 11, 'Công nghệ', 'Ứng dụng kỹ thuật real-time PCR để xác định kiểu gen, lượng virus trong máu và đặc điểm kháng thuốc điều trị của virus viêm gan B trên người bệnh của Bệnh viện Đa khoa Đồng Tháp', 'Ứng dụng kỹ thuật real-time PCR để xác định kiểu gen, lượng virus trong máu và đặc điểm kháng thuốc điều trị của virus viêm gan B trên người bệnh của Bệnh viện Đa khoa Đồng Tháp', '["Lao Đức Thuận","Trương Kim Phượng","Mai Ngọc Lành","Lê Thị Phượng","Phan Văn Bé Bảy","Hồ Thị Thanh Thúy","Lê Huyền Ái Thúy"]', 1, 1439525868, 38, 0, 0, NULL),
	(103, 11, 'Công nghệ', 'Nhân giống in vitro cây Thanh Long ruột đỏ', 'Nhân giống in vitro cây Thanh Long ruột đỏ', '["Đặng Văn Tùng","Nguyễn Trần Đông Phương"]', 1, 1439525970, 38, 0, 0, NULL),
	(104, 11, 'Công nghệ', 'Mô hình dự đoán khuyếch tán ion clorua vào vết nứt bê thông cốt thép trong môi trường biển', 'Mô hình dự đoán khuyếch tán ion clorua vào vết nứt bê thông cốt thép trong môi trường biển', '["Nguyễn Thị Hồng Nhung","Vũ Quốc Hoàng","Nguyễn Ninh Thụy"]', 1, 1439526076, 38, 0, 0, NULL),
	(105, 11, 'TRAO ĐỔI HỌC THUẬT', 'Thương hiệu nhà tuyển dụng: Từ lý luận đến thực tiễn tại Việt Nam', 'Thương hiệu nhà tuyển dụng: Từ lý luận đến thực tiễn tại Việt Nam', '["Nguyễn Khánh Trung","Lê Thị Hoàng Dung"]', 1, 1439526190, 38, 0, 0, NULL),
	(106, 12, 'Kinh tế', 'Vốn xã hội và tăng trưởng kinh tế', 'Vốn xã hội và tăng trưởng kinh tế', '["Nguyễn Văn Phúc","Nguyễn Lê Hoàng Thụy Tố Quyên"]', 1, 1439608754, 38, 0, 0, NULL),
	(107, 12, 'Kinh tế', 'Các yếu tố ảnh hưởng đến rủi ro tín dụng của hệ thống ngân hàng thương mại Việt Nam', 'Các yếu tố ảnh hưởng đến rủi ro tín dụng của hệ thống ngân hàng thương mại Việt Nam', '["Võ Thị Quý","Bùi Ngọc Toản"]', 1, 1439609077, 38, 0, 0, NULL),
	(108, 12, 'Kinh tế', 'Các yếu tố ảnh hưởng đến ý định mua theo nhóm trực tuyến', 'Các yếu tố ảnh hưởng đến ý định mua theo nhóm trực tuyến', '["Hoàng Thị Phương Thảo","Phan Thị Thanh Hằng"]', 1, 1439609159, 38, 0, 0, NULL),
	(109, 12, 'Kinh tế', 'Pr Việt Nam: từ lý thuyết đến thực tiễn', 'Pr Việt Nam: từ lý thuyết đến thực tiễn', '["Vân Thị Hồng Loan"]', 1, 1439609367, 38, 0, 0, NULL),
	(110, 12, 'Kinh tế', 'Tác  động  của  chi  tiêu  công  đến  tăng trưởng kinh tế tại các quốc gia Đông Nam Á ', 'Tác  động  của  chi  tiêu  công  đến  tăng trưởng kinh tế tại các quốc gia Đông Nam Á ', '["Nguyễn Quang Trung","Trần Phạm Khánh Toàn"]', 1, 1439609434, 38, 0, 0, NULL),
	(111, 12, 'Kinh tế', 'Nhận thức của người tiêu dùng về trách nhiệm xã hội của doanh nghiệp vàýđịnh mua  –  Một  nghiên  cứu  từ  ngành  hàng điện máy', 'Nhận thức của người tiêu dùng về trách nhiệm xã hội của doanh nghiệp vàýđịnh mua  –  Một  nghiên  cứu  từ  ngành  hàng điện máy', '["Nguyễn Phan Thanh Nhã","Lê Thị Thanh Xuân"]', 1, 1439609549, 38, 0, 0, NULL),
	(112, 12, 'Giáo dục - Xã hội', 'Đạo  đức  nghề  nghiệp  –  tổng  quan  lý thuyết và nhận thức của sinh viên đại học quốc gia TPHCM', 'Đạo  đức  nghề  nghiệp  –  tổng  quan  lý thuyết và nhận thức của sinh viên đại học quốc gia TPHCM', '["Nguyễn Thu Trang","Trần Tiến Khoa","Lê Thị Thanh Xuân"]', 1, 1439609652, 38, 0, 0, NULL),
	(113, 12, 'Giáo dục - Xã hội', 'Tác động của đào tạo đến hiệu quả làm việc của nhân viên ngành dệt may', 'Tác động của đào tạo đến hiệu quả làm việc của nhân viên ngành dệt may', '["Nguyễn Minh Hà","Lê Văn Tùng"]', 1, 1439609714, 38, 0, 0, NULL),
	(114, 12, 'Giáo dục - Xã hội', 'Tìm  hiểu  sự  tự  học  môn  phương  pháp giảng  dạy  của  sinh  viên  chuyên  ngành giảng dạy tiếng anh theo học chế tín chỉ ', 'Tìm  hiểu  sự  tự  học  môn  phương  pháp giảng  dạy  của  sinh  viên  chuyên  ngành giảng dạy tiếng anh theo học chế tín chỉ ', '["Phan Thị Thu Nga","Trần Vũ Diễm Thúy","Dương Đoàn Hoàng Trúc"]', 1, 1439609802, 38, 0, 0, NULL),
	(115, 12, 'TRAO ĐỔI HỌC THUẬT', 'Khái niệm “văn hóa tổ chức”', 'Khái niệm “văn hóa tổ chức”', '["Nguyễn Quang Vinh"]', 1, 1439609862, 38, 0, 0, NULL),
	(116, 12, 'TRAO ĐỔI HỌC THUẬT', 'Nhàlãnh đạo hiệu quả', 'Nhàlãnh đạo hiệu quả', '["Nguyễn Văn Khanh"]', 1, 1439609939, 38, 0, 0, NULL);
...
DELETE FROM `web_tckh_nhombaiviet`;
...
DELETE FROM `web_uploaded_files`;
...
CREATE TABLE IF NOT EXISTS `web_users` (
  ...
  `phone_numer` char(15) DEFAULT NULL,
  `allow_receive_email` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0: not allow, 1: allow',
...
-- Dumping data for table tckh.web_users: ~4 rows (approximately)
DELETE FROM `web_users`;
/*!40000 ALTER TABLE `web_users` DISABLE KEYS */;
INSERT INTO `web_users` (`id`, `username`, `display_name`, `email`, `password`, `password2`, `address`, `phone_numer`, `allow_receive_email`, `sa`, `buildin_role`, `lastaccess`, `remember_token`, `allow_delete`, `created_at`, `updated_at`) VALUES
	(5, 'admin', 'Administartor', '', '$2a$08$Wzg50R9cLVWOGTIPdnfQYOEmeDDt7hHe3rwoMs/eWOnc3oIHJsj8q', NULL, NULL, NULL, 0, 1, NULL, 1432870370, NULL, 0, '2014-09-18 05:07:53', '2015-05-29 10:32:50'),
	(37, 'no-reply', 'System', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 1, '2015-02-11 18:28:54', '2015-02-11 18:28:54'),
	(38, 'tuyet.htk', 'Huỳnh Thị Kim Tuyết', 'tuyet.htk@ou.edu.vn', '$2y$10$rTSHnbeDtEjIyw.hwZdKaOh3sNro11suAJAG4s2yDTXKKJ8jjUtWW', NULL, NULL, NULL, 0, 0, NULL, 1439608657, NULL, 1, '2015-04-20 10:15:34', '2015-08-15 10:17:37'),
	(39, 'chuong.ha', 'Hồ Anh Chương', '', '$2y$10$cQjEPBXRNtSB9xdi3VdrsOW2cW6LUOUUCwF08Xj5/imagtG3BM07.', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 1, '2015-05-04 09:27:44', '2015-05-04 09:27:44');
